...
export const visionContent: SectionContent = {
  body: (
    <>
      全ての大学が、<span className="highlight">最先端</span>
      のデジタル技術を活用し、世界レベルの教育と研究環境を実現する未来を創造する。
    </>
  ),
};
...
export const valueContent: SectionContent = {
  body: (
    <>
      <span className="highlight">協創</span>、
      <span className="highlight">革新</span>
      、公開性、持続可能性を重んじ、すべてのステークホルダーと共に成長を目指す。
    </>
  ),
};
...
export const activitiesData: Activity[] = [
  {
    ...
    description: (
      <>
        学生・教職員が協力し合い、革新的な大学
        <span className="highlight">アプリ</span>を開発する 48
        時間の開発イベント。
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        UI/UX やモバイル開発、<span className="highlight">生成 AI</span>{" "}
        など最新技術を学ぶ実践的なハンズオンを開催。
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        産学連携で教育・研究プラットフォームを共創し、
        <span className="highlight">成果</span>を共有。
      </>
    ),
